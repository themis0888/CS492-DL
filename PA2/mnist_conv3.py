...
if __name__ == '__main__':
    ...
    train_input = tf.estimator.inputs.numpy_input_fn(x={"x": train_data, 'depth': depth},
    ...
    eval_input = tf.estimator.inputs.numpy_input_fn(x={"x": eval_data, 'depth': depth},
    ...
    np.save('20120888_network_' + str(depth) + '.npy', result)
